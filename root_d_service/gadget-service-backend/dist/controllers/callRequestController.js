...
var createCallRequest = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, phone, newCallRequest, savedCallRequest, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 3:
                error_1 = _b.sent();
                console.error("Error while creating a call request:", error_1);
...
var getCallRequests = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                error_2 = _a.sent();
                console.error("Error while retrieving call requests:", error_2);
...
var deleteCallRequest = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                error_3 = _a.sent();
                console.error("Error while deleting a call request:", error_3);
        ...
        switch (_b.label) {
            ...
            case 2:
                ...
                if (!updatedCallRequest) {
                    return [2 /*return*/, res.status(404).json({ CallRequest: 'Call request not found' })];
                }
                res.status(200).json(updatedCallRequest);
                return [3 /*break*/, 4];
            case 3:
                error_4 = _b.sent();
                console.error("Error while updating the call request:", error_4);
