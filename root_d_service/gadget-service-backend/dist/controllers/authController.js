...
var register = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, username, email, password, userExists, hashedPassword, newUser, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 5:
                error_1 = _b.sent();
                console.log(error_1.message + '         www          ' + error_1);
                return [3 /*break*/, 6];
...
var login = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, password, user, isPasswordCorrect, token, error_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
            ...
            case 3:
                ...
                token = jsonwebtoken_1.default.sign({ id: user._id, email: user.email }, process.env.SECRET_KEY || 'secret', { expiresIn: '2h' });
                // Send the token and user data
                res.status(200).json({ message: 'Login successful', token: token });
                return [3 /*break*/, 5];
            case 4:
                error_2 = _b.sent();
                console.error('Login Error:', error_2); // Log the error
